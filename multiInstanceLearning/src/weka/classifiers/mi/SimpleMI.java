...
public class SimpleMI extends SingleClassifierEnhancer implements
  OptionHandler, MultiInstanceCapabilitiesHandler { // now implements WeightedInstancesHandler to be used with RF and LR
  ...
  public Capabilities getCapabilities() {
    ...
    //result.enable(Capability.);
    //result.enable(Capability.valueOf("weka.core.WeightedInstancesHandler"));
  ...
  public void buildClassifier(Instances train) throws Exception {
    ...
    //TODO weights are not averaged, each instance has a weight of 1 after transformation
    // it probably averages the instances by weight
//    System.out.println("\nPrinting instance weights after SMI transformation...");
//    for(int i = 0; i < Math.min(10, data.numInstances()); i++)
//    {
//      System.out.println(data.instance(i) + " => " + data.instance(i).weight());
//    } // for
