...
# destroy java object cache
#.jcache(mtses, update=NULL)
#.jcache(x_mean, update=NULL)
#.jcache(x_w_mean, update=NULL)
#.jcache(x_w_geo_mean, update=NULL)
#.jcache(x_avg_power, update=NULL)
#.jcache(x_rms, update=NULL)
